...
@section('content')
{!! Form::open(['route' => ['admin.setting.settings.store'], 'method' => 'post', 'files'=>true]) !!}
<div class="row">
                  ...
                  <li>
                    <a href="{{ URL::route('dashboard.module.settings', [$module]) }}"
                       class="{{ $module == $currentModule->getLowerName() ? 'active' : '' }}">
                        {{ trans(strtolower($module).'::'.str_plural(strtolower($module)).'.title.'.str_plural(strtolower($module))) }}
